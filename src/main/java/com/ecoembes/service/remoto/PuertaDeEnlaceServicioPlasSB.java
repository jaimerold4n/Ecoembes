...
@Service("PlasSB")
public class PuertaDeEnlaceServicioPlasSB implements PuertaDeEnlaceServicio {

    private final RestTemplate restTemplate;

    public PuertaDeEnlaceServicioPlasSB() {
        this.restTemplate = new RestTemplate();
    }

    public PuertaDeEnlaceServicioPlasSB(RestTemplate restTemplate) {
